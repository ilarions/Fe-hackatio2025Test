(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_c51938._.js", {
...
async function logWithGoogle(name, email, password) {
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$client$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/auth/register");
        console.log(response);
        return response.data;
    } catch (error) {
        console.error("Ошибка при регистрации:", error);
...
function Page() {
    ...
    const handleRegister = async ()=>{
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerUser"])('name', 'email', 'password');
        } catch (error) {
...
_s(Page, "xcXzFumM7WC8bzPzCxpUihcE9XY=");
_c = Page;
var _c;
...
//# sourceMappingURL=src_c51938._.js.map