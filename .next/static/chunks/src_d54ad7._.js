(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d54ad7._.js", {
...
(()=>{
    const e = new Error("Cannot find module '../client/client'");
...
async function logWithGoogle(name, email, password) {
    try {
        const response = await apiClient.get("/auth/register");
        console.log(response);
        return response.data;
    } catch (error) {
        console.error("Ошибка при регистрации:", error);
...
//# sourceMappingURL=src_d54ad7._.js.map