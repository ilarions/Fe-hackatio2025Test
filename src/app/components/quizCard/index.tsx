"use client"
import { Card, CardContent, CardMedia, Typography, CardActions, Button, Stack, Link } from "@mui/material";
    ...
    <Card sx={{ width: "300px", '&:hover': { boxShadow: "0 5px 1px 5px rgba(0,0,0,0.2)", transform: "translateY(-5px)", transition: ".3s ease-in-out" } }}>
      ...
      <CardContent sx={{ gap: "40px", padding: "10px" }}>
        ...
        <CardActions sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0px" }}>
          ...
          <Link href={`/gameblock/${id}`}><Button variant="contained" sx={{ bgcolor: "#362989" }}>More about quiz</Button></Link>
        </CardActions>
      </CardContent>
    </Card>
  )
